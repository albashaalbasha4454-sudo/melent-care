        ...
        <div className="p-8 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-5" dir="rtl">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.3em] mt-1">Advanced Patient CRM & Case Management</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-10 space-y-12 custom-scrollbar" dir="rtl">
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
               ...
               <h4 className="text-[11px] font-black uppercase text-brand-navy tracking-widest">بيانات الهوية والاتصال (Primary Identity)</h4>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="text" value={formData.country} onChange={e => setFormData({...formData, country: e.target.value})} className="w-full bg-slate-50 border-transparent rounded-[1.5rem] p-4 pl-12 font-bold text-sm focus:bg-white outline-none transition-all" placeholder="Nationality" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="email" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} className="w-full bg-slate-50 border-transparent rounded-[1.5rem] p-4 pl-12 font-bold text-sm focus:bg-white outline-none transition-all" placeholder="Email Address" />
                </div>
              </div>
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
               ...
               <h4 className="text-[11px] font-black uppercase text-brand-navy tracking-widest">التخصيص الطبي (Clinical Assignment)</h4>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <select value={formData.status} onChange={e => setFormData({...formData, status: e.target.value as PatientStatus})} className="w-full bg-brand-navy text-white rounded-[1.5rem] p-4 font-black uppercase tracking-widest text-[10px] outline-none transition-all">
                  <option value="Inquiry">استفسار (Inquiry)</option>
                  <option value="Lead">عميل محتمل (Lead)</option>
                  <option value="Confirmed">مؤكد للسفر (Confirmed)</option>
                  <option value="Active">تحت العلاج (Active)</option>
                  <option value="Discharged">منتهي (Discharged)</option>
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
               ...
               <h4 className="text-[11px] font-black uppercase text-brand-navy tracking-widest">موجز العمليات (Logistics Sync)</h4>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <input type="text" value={formData.notes} onChange={e => setFormData({...formData, notes: e.target.value})} className="w-full bg-slate-50 border-transparent rounded-[1.5rem] p-4 font-bold text-sm focus:bg-white transition-all outline-none" placeholder="Internal coordination briefing..." />
              </div>
            </div>
          </section>
        </form>
